...
const EditRoadPage = () => {
  ...
  const handleConfirm = () => {
    dispatch(editRoad(id, formik.values)); // Update road data
    closeModal();
    dispatch(fetchRoadById(id)); // Refetch road data
    formik.resetForm();
        ...
        <form onSubmit={formik.handleSubmit}>
          <Grid container spacing={3}>
            <Grid item xs={12} md={6}>
              <TextField
                disabled={view ? true : false} // Disable for view mode
                name="road_name"
                label="Road Name"
                fullWidth
            ...
            <Grid item xs={12} md={6}>
              <FormControl fullWidth>
                ...
                <Select
                  ...
                  onChange={formik.handleChange}
                  onBlur={formik.handleBlur}
                  disabled={view ? true : false} // Disable the dropdown on view page
                  error={
